...
import edu.iis.powp.events.predefine.DrawPanelCleaner;
...
public class ApplicationWithDrawer {
	...
	private static void setupDrawerPlugin(Context context) {
        ...
        final DrawPanelCleaner drawPanelCleaner = new DrawPanelCleaner();
        selectClearPanelOptionListener.addObserver(drawPanelCleaner);
